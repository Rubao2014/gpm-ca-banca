...
import br.gov.ba.prefeitura.gpmapp.tasks.TaskCartaDeServicosObtemLista;
 ...
 * Classe FrmMeusDados
 */
public class FrmSeducMatriculaEscolar extends ActivityBase implements IRetornoMASCallbackJSON, Runnable
{
    // Controles da classe
