...
public class TaskCartaDeServicosObtemLista extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskCartaDeServicosObtemLista(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam)
	{
	...
	protected void onPreExecute()
	{
		...
		Apoio.progressDialogMensagem(progressDialog, context.getString(R.string.msg_obtendo_dados_carta_de_servicos));
	}
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "gpm/servicos/negocios/cartaservico/v1/orgaos", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context);
