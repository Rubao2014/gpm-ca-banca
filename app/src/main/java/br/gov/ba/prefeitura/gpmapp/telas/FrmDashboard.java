...
import br.gov.ba.prefeitura.gpmapp.models.ItensMenu;
import br.gov.ba.prefeitura.gpmapp.R;
import br.gov.ba.prefeitura.gpmapp.adapters.AdapterCategoriasDashboard;
import br.gov.ba.prefeitura.gpmapp.adapters.AdapterMenuDashboard;
...
import br.gov.ba.prefeitura.gpmapp.util.IRetornoMASCallbackJSONArray;
import br.gov.ba.prefeitura.gpmapp.util.IRetornoMASCallbackVoid;
import br.gov.ba.prefeitura.gpmapp.util.JSONArrayResponseBody;
import br.gov.ba.prefeitura.gpmapp.util.LogTrace;
import br.gov.ba.prefeitura.gpmapp.util.RetornoMASCallbackJSONArray;
import br.gov.ba.prefeitura.gpmapp.util.RetornoMASCallbackVoid;
