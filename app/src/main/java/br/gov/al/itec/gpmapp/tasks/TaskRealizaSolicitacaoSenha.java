...
public class TaskRealizaSolicitacaoSenha extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe	
	 ...
	 */
	public TaskRealizaSolicitacaoSenha(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam)
	{
	...
	protected void onPreExecute()
	{
		...
		Apoio.progressDialogMensagem(progressDialog, context.getString(R.string.msg_esqueci_minha_senha_solicitando));
	}
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "cidadao/v1/pessoas/reiniciarSenha", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context);
