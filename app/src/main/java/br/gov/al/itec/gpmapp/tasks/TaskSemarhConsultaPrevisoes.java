...
public class TaskSemarhConsultaPrevisoes extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskSemarhConsultaPrevisoes(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam, String sCpfParam)
	{
	...
	protected void onPreExecute()
	{
		...
		progressDialog = Apoio.criarProgressDialog(context, "Aguarde");
		Apoio.progressDialogMensagem(progressDialog, context.getString(R.string.msg_semarh_buscar_previsao));
	}
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "gpm/al/semarh/tempo/previsao/regiao/1/cidade/2", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context);
