...
public class TaskDetranConsultaPontuacao extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskDetranConsultaPontuacao(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam, String sCpfParam)
	{
	...
	protected void onPreExecute()
	{
		...
		Apoio.progressDialogMensagem(progressDialog, context.getString(R.string.msg_detran_buscar_pontuacao));
	}
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "gpm/ac/detran/pontos?cpf=" + sCpf, sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context);
