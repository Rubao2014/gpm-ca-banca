...
public class TaskSemarhConsultaPrevisoes extends AsyncTask<Void, Boolean, Boolean>
{
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "gpm/ca/semarh/tempo/previsao/regiao/1/cidade/2", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context);
