...
public class TaskCriarRelacionamentoCPFCNH extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskCriarRelacionamentoCPFCNH(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam)
	{
	...
	protected void onPreExecute()
	{
		...
		Apoio.progressDialogMensagem(progressDialog, "Atualizando. Aguarde...");
	}
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "iw/transp/cpf_cnh", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context, "application/json");
