...
import br.com.ca.gpmcaieapp.adapters.DependentesBeneficiariosListView;
import br.com.ca.gpmcaieapp.base.ActivityBase;
import br.com.ca.gpmcaieapp.models.Beneficiario;
import br.com.ca.gpmcaieapp.models.CommRespostaToken;
import br.com.ca.gpmcaieapp.models.DependentesBeneficiarios;
...
public class FrmIpasealInicio extends ActivityBase implements View.OnClickListener, IRetornoMASCallbackJSON, Runnable
{
    ...
    private void obtemSituacao() throws Exception
    {
        ...
        uri = mobileSso.getURI(getString(R.string.url_conexao_gateway) + "gpm/ca/ipaseal/contrato/situacao?cpf="+ ValidarCPF.imprimeCPF(sCpf));
        builder = new MASRequest.MASRequestBuilder(uri);
        builder.header("Content-Type", "application/json");
