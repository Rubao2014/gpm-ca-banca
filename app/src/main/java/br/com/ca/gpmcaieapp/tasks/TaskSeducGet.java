...
public class TaskSeducGet extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskSeducGet(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam)
	{
