...
import br.com.ca.gpmcaieapp.adapters.PagerAdapterSemarh;
...
import br.com.ca.gpmcaieapp.tasks.TaskSemarhConsultaPrevisoes;
...
public class FrmSemarh extends ActivityBase implements TabLayout.OnTabSelectedListener, IRetornoMASCallbackJSON, Runnable
{
    ...
    private void carregaPrevisoes() throws Exception
    {
        ...
        Tempo t = new Tempo();
        sDados = jsonArray.getJSONObject(0).getString("temperatura_maxima");
