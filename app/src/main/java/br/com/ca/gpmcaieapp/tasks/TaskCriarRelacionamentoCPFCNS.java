...
public class TaskCriarRelacionamentoCPFCNS extends AsyncTask<Void, Boolean, Boolean>
{
	//Variaveis da classe
	 ...
	 */
	public TaskCriarRelacionamentoCPFCNS(Context contextParam, IComunicacaoGeral comunicacaoGeralParam, String sDadosEnvioParam, String sTokenParam, String sTipoComunicacaoParam)
	{
	...
	protected Boolean doInBackground(Void... voidArg)
	{
		...
		try
		{
			...
			restReturn = RestCommunication.efetuaOperacaoRest(context.getString(R.string.url_conexao_gateway) + "iw/saude/cpf_cns", sTipoComunicacao, sDadosEnvio, Apoio.TIME_OUT_COMUNICACAO, true, sToken, context, "application/json");
